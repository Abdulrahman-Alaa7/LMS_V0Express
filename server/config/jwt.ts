...
export const sendTokenUniversity = (
  user: IUniversity,
  statusCode: number,
  res: Response
) => {
...
export const sendTokenDepartment = (
  user: IDepartment,
  statusCode: number,
  res: Response
) => {
...
export const sendTokenProfessor = (
  user: IProfessor,
  statusCode: number,
  res: Response
) => {
