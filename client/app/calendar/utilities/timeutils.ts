...
function formatTime(hours: any, minutes: any) {
  let md;
  if (minutes === 60) {
    minutes = 0;
    hours += 1;
...
function formatStartEndTimes(hours: any, minutes: any) {
...
function configMinutesForStore(minutes: any) {
  return minutes === 0 ? "00" : minutes;
}

function calcTime(start: any, length: any) {
...
export { configMinutesForStore, formatStartEndTimes, formatTime, compareTimes };
