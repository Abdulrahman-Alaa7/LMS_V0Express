...
const createStatusIcon = () => {
  ...
  document
    .createElementNS("http://www.w3.org/2000/svg", "svg")
    .setAttribute("fill", "var(--white3)");
  document
    .createElementNS("http://www.w3.org/2000/svg", "svg")
    .classList.add("lvhi-status--icon");
...
const createCategoryIcon = () => {
  ...
  document
    .createElementNS("http://www.w3.org/2000/svg", "svg")
    .classList.add("lvhi-category--icon");
  document
    .createElementNS("http://www.w3.org/2000/svg", "svg")
    .append(pathone, pathtwo);
  return document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
const createTrashIcon = (fill: any) => {
  const icon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
const createCloseIcon = (fill: any) => {
  const icon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  icon.setAttribute("height", "20");
  icon.setAttribute("width", "20");
  if (!fill) {
  ...
  pathone.setAttribute(
    "d",
    "M6.062 15 5 13.938 8.938 10 5 6.062 6.062 5 10 8.938 13.938 5 15 6.062 11.062 10 15 13.938 13.938 15 10 11.062Z"
  );
  icon.appendChild(pathone);
  return icon;
};

const createCaretDownIcon = (fill: any) => {
  // const icon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  document
    .createElementNS("http://www.w3.org/2000/svg", "svg")
...
const createCaretUpIcon = (fill: any) => {
  // const icon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  document
    .createElementNS("http://www.w3.org/2000/svg", "svg")
    .setAttribute("height", "18");
...
const createCaretRightIcon = (fill: any) => {
  const icon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  icon.setAttribute("height", "20");
  icon.setAttribute("width", "20");
  if (!fill) {
  ...
  pathone.setAttribute(
    "d",
    "m6 18.167-1.583-1.584L11 10 4.417 3.417 6 1.833 14.167 10Z"
  );
  icon.appendChild(pathone);
  return icon;
};

const createCheckIcon = (fill: any) => {
...
const createCheckBoxIcon = (fill: any) => {
  const icon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  icon.setAttribute("height", "24");
  icon.setAttribute("width", "24");
  if (!fill) {
  ...
  pathone.setAttribute(
    "d",
    "m10.6 16.2 7.05-7.05-1.4-1.4-5.65 5.65-2.85-2.85-1.4 1.4ZM5 21q-.825 0-1.413-.587Q3 19.825 3 19V5q0-.825.587-1.413Q4.175 3 5 3h14q.825 0 1.413.587Q21 4.175 21 5v14q0 .825-.587 1.413Q19.825 21 19 21Zm0-2h14V5H5v14ZM5 5v14V5Z"
  );
  icon.appendChild(pathone);
  return icon;
};

const createMeatballVertIcon = (fill: any) => {
  const icon = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  icon.setAttribute("height", "24");
  icon.setAttribute("width", "24");
  if (!fill) {
  ...
  pathone.setAttribute(
    "d",
    "M6 14q-.825 0-1.412-.588Q4 12.825 4 12t.588-1.413Q5.175 10 6 10t1.412.587Q8 11.175 8 12q0 .825-.588 1.412Q6.825 14 6 14Zm6 0q-.825 0-1.412-.588Q10 12.825 10 12t.588-1.413Q11.175 10 12 10t1.413.587Q14 11.175 14 12q0 .825-.587 1.412Q12.825 14 12 14Zm6 0q-.825 0-1.413-.588Q16 12.825 16 12t.587-1.413Q17.175 10 18 10q.825 0 1.413.587Q20 11.175 20 12q0 .825-.587 1.412Q18.825 14 18 14Z"
  );
  icon.appendChild(pathone);
  return icon;
};

const createExpandDownIcon = (fill: any) => {
  {
