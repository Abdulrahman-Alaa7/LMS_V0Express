...
const colorSchemeMeta =
  typeof window !== "undefined"
    ? document.getElementsByName("color-scheme")[0]
    : null;

const header =
  typeof window !== "undefined"
    ? document.querySelector(".h__container")
    : null;
const headerLogo =
  typeof window !== "undefined" ? document.querySelector(".logo") : null;

const toggleForm =
  typeof window !== "undefined" ? document.querySelector(".toggle-form") : null;
const sbToggleForm =
  typeof window !== "undefined"
    ? document.querySelector(".sb-toggle-form-btn")
    : null;
const sbToggleSubBtn =
  typeof window !== "undefined" ? document.querySelector(".sb-data-btn") : null;
const formOverlay =
  typeof window !== "undefined"
...
const sbDatepickerBody =
  typeof window !== "undefined"
    ...
    : null;
const sbCategoriesWrapper =
  typeof window !== "undefined"
    ? document.querySelector(".sb__categories--body-form")
    : null;

const selectElement =
  typeof window !== "undefined"
    ? document.querySelector(".select__modal")
    : null;
const selectOverlay =
  typeof window !== "undefined"
    ? document.querySelector(".change-view--overlay")
    : null;
const optionswrapper =
  typeof window !== "undefined"
    ? document.querySelector(".change-view--wrapper")
    : null;
const options =
  typeof window !== "undefined"
...
const sbCategories =
  typeof window !== "undefined"
    ? document.querySelector(".sb__categories")
    : null;

const viewsContainer =
  typeof window !== "undefined"
    ? document.querySelector(".container__calendars")
    : null;
const yearwrapper =
  typeof window !== "undefined" ? document.querySelector(".yearview") : null;
const monthwrapper =
  typeof window !== "undefined" ? document.querySelector(".monthview") : null;
const listviewBody =
  typeof window !== "undefined"
    ? document.querySelector(".listview__body")
    : null;

const collapsebtn =
  typeof window !== "undefined"
    ? document.querySelector(".collapse-view")
    : null;
...
export default function renderViews(context, datepickerContext, store) {
  ...
  function setInitialAttributes() {
    selectElement?.setAttribute(
      "data-value",
      `${context.getComponent().slice(0, 1).toUpperCase()}`
    );
  ...
  function handleCollapse() {
    ...
    if (view === "week" || view === "day") {
      ...
      if (view === "week") {
        headers[view].componentBody.classList.toggle(
          headers[view].componentBodytoggle
        );
      }
    }
  }
