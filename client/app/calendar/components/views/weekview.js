...
const main =
  typeof window !== "undefined" ? document.querySelector(".weekview") : null;
const container =
  typeof window !== "undefined"
    ? document.querySelector(".weekview--calendar")
    : null;
const weekviewHeader =
  typeof window !== "undefined"
    ? document.querySelector(".weekview--header")
    : null;
const weekviewHeaderDayNumber =
  typeof window !== "undefined"
    ? document.querySelectorAll(".weekview--header-day__number")
    : null;

const weekviewGrid =
  typeof window !== "undefined"
    ? document.querySelector(".weekview__grid")
    : null;
const weekviewSideGrid =
  typeof window !== "undefined"
    ? document.querySelector(".weekview--sidebar")
    : null;

const topCols =
  typeof window !== "undefined"
    ? document.querySelectorAll(".allday--col")
    : null;

const cols =
  typeof window !== "undefined"
    ? document.querySelectorAll(".week--col")
    : null;
...
export default function setWeekView(context, store, datepickerContext) {
  ...
  function configureDaysOfWeek() {
    const wvgmt = document.querySelector(".wv-gmt");
    if (wvgmt) {
      wvgmt.textContent = `UTC ${context.getGmt()}`;
    }
    let hasToday;
    let hasSelected;
    let dayNumbers = [];
    ...
    dayNumbers.forEach((num, idx) => {
      if (weekviewHeaderDayNumber) {
        ...
        if (weekviewHeaderDayNumber[idx]) {
          weekviewHeaderDayNumber[idx].textContent = num;
          weekviewHeaderDayNumber[idx]?.setAttribute(
            "data-weekview-date",
            ymd[idx]
          );
        }
