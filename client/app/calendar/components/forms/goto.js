...
const gotoOverlay =
  typeof window !== "undefined"
    ? document.querySelector(".go-to-date-overlay")
    : null;
const goto =
  typeof window !== "undefined" ? document.querySelector(".go-to-date") : null;
const gotoInput =
  typeof window !== "undefined" ? document.querySelector(".go-to-input") : null;
const inputErrMessage =
  typeof window !== "undefined" ? document.querySelector(".go-to-err") : null;
const cancelGoto =
  typeof window !== "undefined"
    ? document.querySelector(".cancel-go-to")
    : null;
const submitGoto =
  typeof window !== "undefined"
    ? document.querySelector(".submit-go-to")
    : null;
