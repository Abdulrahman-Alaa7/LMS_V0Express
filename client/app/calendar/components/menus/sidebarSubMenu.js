...
const sidebarSubMenuOverlay =
  typeof window !== "undefined"
    ? document.querySelector(".sidebar-sub-menu__overlay")
    : null;
const sidebarSubMenu =
  typeof window !== "undefined"
    ? document.querySelector(".sidebar-sub-menu")
    : null;
const closeSubMenuBtn =
  typeof window !== "undefined"
    ? document.querySelector(".close-sub-menu")
    : null;
...
const themeRadioBtns =
  typeof window !== "undefined"
    ? document.querySelectorAll(".theme-radio__input")
    : null;
...
const shortcutSwitch =
  typeof window !== "undefined"
    ? document.querySelector(".smia-toggle-shortcuts-checkbox")
    : null;
const animationsSwitchBtn =
  typeof window !== "undefined"
    ? document.querySelector(".smdt-toggle-checkbox")
    : null;
const notifyDisabledShortcutsIcon =
  typeof window !== "undefined"
    ? document.querySelector(".keyboard-disabled-sm")
    : null;
