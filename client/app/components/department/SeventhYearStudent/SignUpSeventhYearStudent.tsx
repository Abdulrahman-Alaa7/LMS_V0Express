...
import VerificationSeventhYearStudent from "./VerificationSeventhYearStudent";
...
const SignUpSeventhYearStudent: FC<Props> = ({ refetch }) => {
        ...
        <>
          {open && (
            <CustomModal
              ...
              setOpen={setOpen}
              setRoute={setRoute}
              component={VerificationSeventhYearStudent}
              refetch={refetch}
            />
          )}
        </>
...
export default SignUpSeventhYearStudent;
