...
import SignUpSeventhYearStudent from "./SignUpSeventhYearStudent";
...
const SeventhYearStudent: FC<Props> = () => {
  ...
  const [edityear, setEditYaer] = useState(userData?.user?.yearSeven.yearId);
  ...
  const matchingUsers = data?.users?.filter(
    (user: any) =>
      user?.studentYearOfStudy === userData?.user?.yearSeven?.yearId
  );
  ...
  const handlePromote = async () => {
    ...
    const studentYearOfStudy = userData?.user?.yearSeven?.yearId;
        ...
        <>
          {openSignUp && (
            <CustomModal
              ...
              setRoute={setRoute}
              component={SignUpSeventhYearStudent}
              refetch={refetch}
            />
          )}
        </>
...
export default SeventhYearStudent;
