...
import VerificationFifthYearStudent from "./VerificationFifthYearStudent";
...
const SignUpFifthYearStudent: FC<Props> = ({ refetch }) => {
        ...
        <>
          {open && (
            <CustomModal
              ...
              setOpen={setOpen}
              setRoute={setRoute}
              component={VerificationFifthYearStudent}
              refetch={refetch}
            />
          )}
        </>
...
export default SignUpFifthYearStudent;
