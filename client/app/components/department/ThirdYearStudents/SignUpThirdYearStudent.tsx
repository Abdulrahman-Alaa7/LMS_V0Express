...
import VerificationThirdYearStudent from "./VerificationThirdYearStudent";
...
const SignUpThirdYearStudent: FC<Props> = ({ refetch }) => {
        ...
        <>
          {open && (
            <CustomModal
              ...
              setOpen={setOpen}
              setRoute={setRoute}
              component={VerificationThirdYearStudent}
              refetch={refetch}
            />
          )}
        </>
...
export default SignUpThirdYearStudent;
