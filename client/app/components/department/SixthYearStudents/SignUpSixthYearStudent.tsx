...
import VerificationSixthYearStudent from "./VerificationSixthYearStudent";
...
const SignUpSixthYearStudent: FC<Props> = ({ refetch }) => {
        ...
        <>
          {open && (
            <CustomModal
              ...
              setOpen={setOpen}
              setRoute={setRoute}
              component={VerificationSixthYearStudent}
              refetch={refetch}
            />
          )}
        </>
...
export default SignUpSixthYearStudent;
