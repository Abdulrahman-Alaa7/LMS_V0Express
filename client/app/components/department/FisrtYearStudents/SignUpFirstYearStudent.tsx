...
import VerificationFisrtYearStudent from "./VerificationFisrtYearStudent";
...
const SignUpFisrtYearStudent: FC<Props> = ({ refetch }) => {
  ...
  const studentYearOfStudy = userData?.user?.yearOne?.yearId;
        ...
        <>
          {open && (
            <CustomModal
              ...
              setOpen={setOpen}
              setRoute={setRoute}
              component={VerificationFisrtYearStudent}
              refetch={refetch}
            />
          )}
        </>
...
export default SignUpFisrtYearStudent;
