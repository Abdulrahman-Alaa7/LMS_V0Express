...
import VerificationForthYearStudent from "./VerificationFourthYearStudent";
...
const SignUpFourthYearStudent: FC<Props> = ({ refetch }) => {
        ...
        <>
          {open && (
            <CustomModal
              ...
              setOpen={setOpen}
              setRoute={setRoute}
              component={VerificationForthYearStudent}
              refetch={refetch}
            />
          )}
        </>
...
export default SignUpFourthYearStudent;
