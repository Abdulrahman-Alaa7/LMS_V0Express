...
const ProfileInfo: FC<Props> = ({ avatar, user }) => {
  ...
  const [editProfile, { isSuccess: forSuccess, error: forError }] =
    useEditProfileMutation();
          ...
          <div className={`800px:w-[50%] m-auto block pb-4`}>
            <div className={`w-[100%] relative mb-6`}>
              <input
                ...
                id="manager-name"
              />
              <label htmlFor="manager-name" className={`${styles.SpLabel} `}>
                Manger name
              </label>
            </div>
            <div className={`w-[100%]  relative mb-6`}>
              <input
                ...
                id="manager-email"
              />
              <label htmlFor="manager-email" className={`${styles.SpLabel} `}>
                Manger email
              </label>
            </div>
            <div className={`w-[100%] relative mb-6`}>
              <input
                ...
                id="manager-role"
              />
              <label htmlFor="manager-role" className={`${styles.SpLabel} `}>
                Role
              </label>
            </div>
