...
import { useRegisterUniversityMutation } from "../../../../redux/features/auth/authApi";
import toast from "react-hot-toast";
import CustomModal from "../../../utils/CustomModal";
import { LiaUniversitySolid } from "react-icons/lia";
import VerificationUniversity from "./VerificationUniversity";
...
const SignUPUniversity: FC<Props> = ({ refetch }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async ({ name, email, password }) => {
      const data = { name, email, password, userCreatedById };
        ...
        <>
          {open && (
            <CustomModal
              ...
              setOpen={setOpen}
              setRoute={setRoute}
              component={VerificationUniversity}
              refetch={refetch}
            />
          )}
        </>
