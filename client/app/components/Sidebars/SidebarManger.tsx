...
import { FaUniversity, FaUserCog } from "react-icons/fa";
...
const SidebarManger: FC<Props> = ({ user, openSidebar, setOpenSidebar }) => {
      ...
      <Box sx={{ display: "flex" }}>
        ...
        >
          ...
          <List>
            ...
            <Divider className="!border-[#9e9e9e29]" />
            <ListItem disablePadding>
              <Link href={`/manger-area`} className="w-full">
                <ListItemButton
                  className={`hover:!bg-[#9e9e9e29] !rounded-lg flex items-center gap-4 !mx-2 !my-1  ${currentPagePath === "/manger-area" && "!bg-[#9e9e9e29]"}`}
                >
                  <div>
                    <FaUserCog size={25} className="dark:text-gray-300" />
                  </div>
                  <ListItemText
                    primary={`Managers Area`}
                    className={`dark:text-white  `}
                  />
                </ListItemButton>
              </Link>
            ...
            <Divider className="!border-[#9e9e9e29]" />
            <ListItem disablePadding>
              <Link href={`/university-area`} className="w-full">
                <ListItemButton
                  className={`hover:!bg-[#9e9e9e29] !rounded-lg flex items-center gap-4 !mx-2 !my-1  ${currentPagePath === "/university-area" && "!bg-[#9e9e9e29]"}`}
                >
                  <div>
                    <FaUniversity size={25} className="dark:text-gray-300" />
                  </div>
                  <ListItemText
                    primary={`University Area`}
                    className={`dark:text-white  `}
                  />
                </ListItemButton>
              </Link>
