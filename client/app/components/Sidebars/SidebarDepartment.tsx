...
const SidebarDepartment: FC<Props> = ({
  user,
  openSidebar,
  setOpenSidebar,
}) => {
      ...
      <Box sx={{ display: "flex" }}>
        ...
        >
          ...
          <List>
            ...
            <Divider className="!border-[#9e9e9e29]" />
            <ListItem disablePadding>
              <Link href={`/professor-area`} className="w-full">
                <ListItemButton
            ...
            <Divider className="!border-[#9e9e9e29]" />
            <ListItem disablePadding>
              <Link href={`/student-area`} className="w-full">
                <ListItemButton
                  className={`hover:!bg-[#9e9e9e29] !rounded-lg flex items-center gap-4 !mx-2 !my-1  ${currentPagePath === "/student-area" && "!bg-[#9e9e9e29]"}`}
                >
                  <div>
                    <PiStudentFill size={25} className="dark:text-gray-300" />
                  </div>
                  <ListItemText
                    primary={`Students Area`}
                    className={`dark:text-white  `}
                  />
                </ListItemButton>
              </Link>
            ...
            <Divider className="!border-[#9e9e9e29]" />
            <ListItem disablePadding>
              <Link href={`/semester-area`} className="w-full">
                <ListItemButton
                  className={`hover:!bg-[#9e9e9e29] !rounded-lg flex items-center gap-4 !mx-2 !my-1  ${currentPagePath === "/semester-area" && "!bg-[#9e9e9e29]"}`}
                >
                  <div>
