...
const UniversityHeader: FC<Props> = ({ active, setActive }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        className={`p-2 mx-2 min-w-[150px] rounded-lg font-semibold transition-all ${active === 2 ? "bg-white text-black " : "hover:bg-white hover:text-black"}`}
        onClick={() => setActive(2)}
      >
        Professors
      </button>
      <button
        type="button"
        className={`p-2 mx-2 min-w-[150px] rounded-lg font-semibold transition-all ${active === 3 ? "bg-white text-black " : "hover:bg-white hover:text-black"}`}
        onClick={() => setActive(3)}
      >
        Students
      </button>
