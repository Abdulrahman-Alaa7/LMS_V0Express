...
const ProfileInfoFaculty: FC<Props> = ({ avatar, user }) => {
  const [name, setName] = useState(user && user.name);
  const [updateAvatarFaculty, { isSuccess, error }] =
    useUpdateAvatarFacultyMutation();
  const [editProfileFaculty, { isSuccess: forSuccess, error: forError }] =
    useEditProfileFacultyMutation();
...
export default ProfileInfoFaculty;
