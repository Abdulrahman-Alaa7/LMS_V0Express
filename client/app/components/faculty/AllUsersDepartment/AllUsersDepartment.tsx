...
import SignUpDepartment from "../CreateDepartment/SignUpDepartment";
...
const AllUsersDepartment: FC<Props> = ({ isSignUp }) => {
  ...
  const { isLoading, data, error, refetch } = useGetAllUsersDepartmentQuery(
    {},
...
export default AllUsersDepartment;
